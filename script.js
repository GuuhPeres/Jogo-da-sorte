document.addEventListener("DOMContentLoaded", () => {
  ...
  // -------- Nível 2 --------
  function nivel2() {
    mensagemJogo.textContent = "Escolha entre 3 cartas:";
    containerCartas.innerHTML = "";
  ...
  // -------- Nível 3 --------
  function nivel3() {
    mensagemJogo.textContent = "Escolha entre 4 cartas:";
    containerCartas.innerHTML = "";
  ...
  function calma2(babyCarta) {
    ...
    containerCartas.appendChild(babyCarta);
    mensagemJogo.textContent = "Escolha entre 4 cartas (2 Magos do Tempo e 2 Dragon Capture):";
  ...
  function calma3(babyCarta) {
    ...
    babyCarta.classList.add("topo");
    containerCartas.appendChild(babyCarta);
    mensagemJogo.textContent = "Escolha entre 4 cartas (1 Mago do Tempo e 3 Dragon Capture):";
